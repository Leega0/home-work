...
$(function() {
  ...
  $progress.each(function() {
    var _self = $(this),
        ...
        value = _self.find('.account-progress-value').prop ('firstChild').nodeValue;
...
function inputInit() {
  ...
  $input_label.on('touchend', function() {
    var $this = $(this);
  ...
  $input_clear.on('touchend', function() {
    var $this = $(this);
  ...
  var methods = {
    init: function(options) {
      return this.each(function () {
        ...
        settings.btn.on('touchend', function(e) {
          e.preventDefault();

          settings.input.trigger('touchend');
        });
...
$.loadingShow = function() {
  ...
  $shade.addClass('ui-shade-white');

};

$.loadingHide = function() {
  $(document).find('.ui-loading').parent('.ui-shade-white').remove();
};